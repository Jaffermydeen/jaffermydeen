...
I believe in continuous learning and staying at the cutting edge of Technology. my goal is to leverage data analytics to solve real-world problems and drive innovation.  <span className="text-gradient font-serif text-2xl">I </span>
          </h2>
        </AnimatedSection>
