  ...
  return <section id="about" className="relative">
      <div className="section-container">
        <AnimatedSection>
          ...
          <h2 className="section-title font-normal bg-primary-foreground text-zinc-50">Get to Know 
...
I believe in continuous learning and staying at the cutting edge of Technology. my goal is to leverage data analytics to solve real-world problems and drive innovation.  <span className="text-gradient font-serif text-2xl"></span>
          </h2>
        </AnimatedSection>
