  ...
  return <section id="about" className="relative">
      <div className="section-container">
        <AnimatedSection>
          ...
          <h2 className="section-title font-normal text-primary-foreground bg-primary-foreground">Get to Know 
...
I believe in continuous learning and staying at the cutting edge of Technology. my goal is to leverage data analytics to solve real-world problems and drive innovation.  <span className="text-gradient font-serif text-2xl">I am a passionate Aspiring Data Analyst and BCA Graduate with strong skills in , Excel,  Power BI and SQL . I enjoy working with data to uncover insights, create dashboards, and support data-driven decisions. My academic background in computer applications has helped me build a strong foundation in analytical thinking and problem-solving. I am continuously learning new tools and techniques to grow as a data professional. I believe in continuous learning and staying at the cutting edge of Technology. my goal is to leverage data analytics to solve real-world problems and drive innovation.  </span>
          </h2>
        </AnimatedSection>
