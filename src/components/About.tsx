...
const stats = [
  ...
  { icon: Database, label: 'Data Sets Analyzed', value: '50+' },
  { icon: Zap, label: 'Technologies Used', value: '20+' },
  { icon: TrendingUp, label: 'Years Learning', value: '3+' },
];
          ...
          <AnimatedSection delay={0.2} direction="left">
            <div className="space-y-6">
              <p className="text-muted-foreground leading-relaxed text-lg">
                I'm a passionate <span className="text-foreground font-medium">Electrical Engineer</span> and{' '}
                <span className="text-foreground font-medium">aspiring Data Analyst</span> with a deep love
