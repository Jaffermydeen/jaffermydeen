    ...
    >
      <div className="section-container flex flex-col lg:flex-row items-center gap-12 pt-24">
        ...
        >
          ...
          >
            Hi, I'm{' '}
            <span className="text-gradient">Jaffer Mydeen A</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-muted-foreground text-lg md:text-xl lg:text-2xl mb-8 max-w-xl mx-auto lg:mx-0"
          >
            Aspiring Data Analyst | Electrical Engineer | Tech Enthusiast
          </motion.p>
